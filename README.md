...
- **Frontend:** `Vue.js` ❤️ · `React` · `Tailwind CSS`
- **Backend:** `Node.js` · `NestJS` · `PostgreSQL` · `REST` · `WebSocket`
- **AI Engineering:** `RAG` · `LangChain` · `ChromaDB` · `MCP`
- **Cloud & DevOps:** `Google Cloud Platform` · `AWS` · `Docker` · `GitHub Actions`
- **Testing & Tooling:** `Vitest` · `Playwright` · `Storybook` · `Nx` · `Vite`
- **Platforms:** `macOS` · `iOS`
